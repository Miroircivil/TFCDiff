...
def Data_Preparation(noise_version=1):
    ...
    # rnd ~ [0.2, 2]
    if not os.path.exists('rnd_train.npy'):
        rnd_train = np.random.randint(low=20, high=200, size=len(signals_train)) / 100
        # Saving the random array for better replications
        np.save('rnd_train.npy', rnd_train)
        print("rnd_train has been created, loading......")
    else:
        print("rnd_train has existed, loading......")
        rnd_train = np.load('rnd_train.npy')
    print('rnd_train shape: ' + str(rnd_train.shape))
    ...
    if not os.path.exists('rnd_test.npy'):
        ...
        print("rnd_test.npy has been created, loading......")
    else:
        print("rnd_test.npy has existed, loading......")
