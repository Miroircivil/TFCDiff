...
if __name__ == "__main__":
    ...
    for nv in noise_versions:
        ...
        X_test = X_test.numpy()[:,:3584,:]/200
        y_test = y_test.numpy()[:,:3584,:]/200
    ...
    ImSNR_values_DL_DRNN = SNR_improvement(X_test, y_pred, y_test)
    ...
    ImSNR_all = [ImSNR_values_FIR,
                 ImSNR_values_IIR,
                 ImSNR_values_DL_DRNN,
                 ImSNR_values_DL_FCN_DAE,
                 ImSNR_values_DL_exp_1,
                 ImSNR_values_DL_exp_2,
                 ImSNR_values_DL_exp_3,
                 ImSNR_values_DL_exp_4,
                 ]
