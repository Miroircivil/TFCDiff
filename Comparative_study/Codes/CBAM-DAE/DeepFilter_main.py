...
if __name__ == "__main__":
    ...
    # # Load Results Vanilla_DAE
    # with open('test_results_' + dl_experiments[2] + '_nv1.pkl', 'rb') as input:
    #     test_Vanilla_DAE_nv1 = pickle.load(input)
    ...
    # test_Vanilla_DAE = [test_Vanilla_DAE_nv1[0],
    #                 test_Vanilla_DAE_nv1[1],
    #                 test_Vanilla_DAE_nv1[2]]
    ...
    # ImSNR_values_DL_Vanilla_DAE = SNR_improvement(X_test, y_pred, y_test)
