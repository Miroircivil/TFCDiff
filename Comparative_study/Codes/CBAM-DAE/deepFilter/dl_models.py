...
from keras.layers import Dense, Conv1D, Dropout, BatchNormalization,\
...
class AttentionBlock(Layer):
    def __init__(self, signal_size, channels, kernel_size=16,
                 input_size=None, activation='leaky_relu'):
...
class AttentionBlockBN(Layer):
    def __init__(self, signal_size, channels, kernel_size=16,
        ...
        self.activation = ks.layers.LeakyReLU()
...
class AttentionDeconv(ks.layers.Layer):
    def __init__(self, signal_size, channels, kernel_size=16,
                 input_size=None, activation='leaky_relu',
...
class AttentionDeconvBN(ks.layers.Layer):
    def __init__(self, signal_size, channels, kernel_size=16,
                 input_size=None, activation='leaky_relu',
                 strides=2, padding='same'):
...
class AttentionDeconvECA(ks.layers.Layer):
    def __init__(self, signal_size, channels, kernel_size=16,
                 input_size=None, activation='leaky_relu',
                 strides=2, padding='same'):
...
class AttentionSkipDAE(ks.Model):
    def __init__(self, signal_size=3584):
...
class ECASkipDAE(ks.Model):
    def __init__(self, signal_size=3584):
        super(ECASkipDAE, self).__init__()
        self.signal_size = signal_size

    def build(self, input_shape):
        self.b1 = EncoderBlock(self.signal_size, 16, input_size=(self.signal_size, 1), kernel_size=13)
        self.b2 = EncoderBlock(self.signal_size//2, 32, kernel_size=7)
        self.b3 = EncoderBlock(self.signal_size//4, 64, kernel_size=7)
        self.b4 = EncoderBlock(self.signal_size//8, 64, kernel_size=7)
        self.b5 = EncoderBlock(self.signal_size//16, 1, kernel_size=7) #32
        self.d5 = AttentionDeconvECA(self.signal_size//16, 64, kernel_size=7)
        self.d4 = AttentionDeconvECA(self.signal_size//8, 64, kernel_size=7)
        self.d3 = AttentionDeconvECA(self.signal_size//4, 32, kernel_size=7)
        self.d2 = AttentionDeconvECA(self.signal_size//2, 16, kernel_size=7)
        self.d1 = AttentionDeconvECA(self.signal_size, 1, activation='linear', kernel_size=13)
        self.dense = ks.layers.Dense(self.signal_size)
        super(ECASkipDAE, self).build(input_shape)
...
class VanillaAutoencoder(ks.Model):
    def __init__(self, signal_size=3584, activation='leaky_relu'):
...
class AttentionSkipDAE2(ks.Model):
    def __init__(self, signal_size=3584):
        super(AttentionSkipDAE2, self).__init__()
        self.signal_size = signal_size

    def build(self, input_shape):
        self.b1 = AttentionBlockBN(self.signal_size, 16, input_size=(self.signal_size, 1))
        self.b2 = AttentionBlockBN(self.signal_size//2, 32)
        self.b3 = AttentionBlockBN(self.signal_size//4, 64)
        self.b4 = AttentionBlockBN(self.signal_size//8, 64)
        self.b5 = AttentionBlockBN(self.signal_size//16, 1) #32
        self.d5 = AttentionDeconvBN(self.signal_size//16, 64)
        self.d4 = AttentionDeconvBN(self.signal_size//8, 64)
        self.d3 = AttentionDeconvBN(self.signal_size//4, 32)
        self.d2 = AttentionDeconvBN(self.signal_size//2, 16)
        self.d1 = AttentionDeconvBN(self.signal_size, 1, activation='linear')
        super(AttentionSkipDAE2, self).build(input_shape)
