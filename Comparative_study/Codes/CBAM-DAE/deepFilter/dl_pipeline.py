...
def train_dl(Dataset, experiment, signal_size=3584, ds=''):
    ...
    if experiment == 'Attention Skip DAE':
        ...
        model.build(input_shape=(128, signal_size, 1))
    ...
    # checkpoint
    model_filepath = model_label + f'_.best.weights.h5'
...
def test_dl(Dataset, experiment, signal_size=3584, ds=''):
