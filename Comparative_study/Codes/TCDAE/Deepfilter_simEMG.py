...
if __name__ == "__main__":
    ...
    for nv in noise_versions:
        ...
        X_test = torch.load('./X_test_simEMG.pt')
        y_test = torch.load('./y_test_simEMG.pt')
    ...
    test_Transformer_DAE = [test_Transformer_DAE_nv1[0],
                 test_Transformer_DAE_nv1[1],
                 test_Transformer_DAE_nv1[2]]
    ...
    COS_SIM_values_DL_Transformer_DAE = COS_SIM(y_test, y_pred)

    ImSNR_values_DL_Transformer_DAE = SNR_improvement(X_test, y_pred, y_test)
    ...
    PRD_all = [
               PRD_values_DL_Transformer_DAE,
               ]

    COS_SIM_all = [
                   COS_SIM_values_DL_Transformer_DAE,
                   ]
    
    ImSNR_all = [
                 ImSNR_values_DL_Transformer_DAE,
                 ]
